...
import com.herry.loopsnaprecyclerview.lib.LoopPagerSnapExHelper;
...
public class LoopPagerActivity extends AppCompatActivity {
    ...
    private LoopPagerSnapExHelper snapHelper = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setTitle("Manual Looping Pager");
        ...
        if (null != recyclerView) {
            ...
            snapHelper = new LoopPagerSnapExHelper();
